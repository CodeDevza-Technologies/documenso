...
/**
 * How long the initial unbranded (OperifyAI Sign default) state is shown before
...
export const EmailDomainsUpsell = () => {
  ...
  // Loop from index 1: the unbranded OperifyAI Sign intro plays exactly once,
              ...
              >
                ...
                <span className="truncate">
                  {isBranded ? (
                    ...
                    <Trans>Sending from send.codedevza.co.uk</Trans>
                  )}
                </span>
              </motion.div>
            </AnimatePresence>
              ...
              <div className="min-w-0">
                <div className="font-medium text-sm">
                  <AnimatePresence mode="wait" initial={false}>
                    ...
                    >
                      <span className="min-w-0 truncate">{isBranded ? brandedSender.name : 'OperifyAI Sign'}</span>
