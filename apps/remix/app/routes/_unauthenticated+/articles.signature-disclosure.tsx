  ...
  return (
    <div>
      <article className="prose dark:prose-invert">
        ...
        <p>
          <Trans>
            Thank you for using OperifyAI Sign to perform your electronic document signing. The purpose of this
        ...
        <p>
          <Trans>
            By proceeding to use the electronic signature service provided by OperifyAI Sign, you affirm that you have
