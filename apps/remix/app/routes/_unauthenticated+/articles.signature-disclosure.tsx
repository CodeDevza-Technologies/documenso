  ...
  return (
    <div>
      <article className="prose dark:prose-invert">
        ...
        <p>
          <Trans>
            Thank you for using Codedevza AI Sign to perform your electronic document signing. The purpose of this disclosure is
        ...
        <p>
          <Trans>
            By proceeding to use the electronic signature service provided by Codedevza AI Sign, you affirm that you have read
